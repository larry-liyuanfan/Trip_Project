...
def run(path):
    ...
    for profile in config["profiles"]:
        ...
        if profile not in {"release_adapter", "formal_adapter", "repaired_adapter", "repaired_base",
                           "observation_base", "observation_enhanced_base", "observation_candidate_base",
                           "observation_incumbent", "observation_evidence_guard"}:
