...
def replay_record(root, record, observation=None):
    ...
    if observation is not None and observation.get("facility_refinement") is not None:
        from src.inference.product_facility_refinement import replay_facility_refined_observation
        value = replay_facility_refined_observation(record, observation)
    elif observation is not None and observation.get("category_refinement") is not None:
