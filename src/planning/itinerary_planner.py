"""Deterministic itinerary baseline for retrieved OTA candidates."""
...
def build_itinerary(
    ...
    """Assign candidates to time slots and explain preference relevance."""
...
def _time_slots(count: int, pace: str) -> list[str]:
    """Choose relaxed or compact slots and cycle when candidates exceed four."""
...
def _reason(candidate: dict[str, Any], preferences: dict[str, Any]) -> str:
    """Explain direct category-interest matches or the baseline selection path."""
