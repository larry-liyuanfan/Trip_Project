...
日期：2026-09-15。代码提交：`a695406538b30cf3caa03683bbfe9c7f1f1218a6`。
...
结果：30/30 tests passed，0 failed、0 error、0 skip；测试框架报告 0.831 秒，外层计时
1.001 秒。原有 inventory 18 项全部保留通过，新增导入校验 12 项通过。CLI fixture 覆盖
成功 exit 0、失败 exit 2、失败不落盘和输出不可覆盖；12-scope 成功 fixture 仍保持
`model_execution_authorized=false`。`git diff --check` 通过。

提交后文件 SHA-256：

| 文件 | SHA-256 |
| --- | --- |
| `src/evaluation/protected_identity_inventory.py` | `90413f0389ceb09609634f53847871859e82857c42ac6b0f75e21a2601d79144` |
| `scripts/validate_identity_only_import.py` | `d5a53a605976333c16c325a73d48647a382ed41bf89df9c9f9dd9ea4e76f6a1e` |
| `tests/test_protected_identity_inventory.py` | `2497665e3778dfaf2768943c7b9d07c4a4c273c128979e49686252155d51ddbc` |
